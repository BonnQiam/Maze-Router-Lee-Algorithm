...
extern unsigned short int NEIGHBOR_RANDOM_POSSIBILITY;//全局变量
...
//For all neighborhood, do function. Using *functionData to pass value to the function by reference
